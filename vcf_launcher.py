...
class VCF_OT_VCFDISLancher(bpy.types.Operator):
...
class VCF_PT_VCFManager(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        launch_dis_op_cls = VCF_OT_VCFDISLancher
        clear_op_cls = VCF_OT_VCFClearer
        clear_dis_op_cls = VCF_OT_VCFDISClearer
...
classes = [
    VCF_OT_VCFLancher,
    VCF_OT_VCFDISLancher,
    VCF_OT_VCFClearer,
    VCF_OT_VCFDISClearer,
    VCF_PT_VCFManager,
]               
